...
<nav class="navbar navbar-light navbar-expand-md py-3 navbg fixed-top">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-text-indent-left" style="padding-right: 0px;margin-right: 0px;font-size: 27px;">
            ...
            <div class="collapse navbar-collapse" id="navcol-3">
                ...
                <div class="input-group" style="width: 20%;margin-right: 42px;"><input class="bg-light form-control border-0 small" name="q"  type="text" placeholder="Search for ..."><button class="btn btn-primary py-0" type="button" style="background-color: #d190e2;border: none;"><i class="fas fa-search"></i></button></div>
                <div class="dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small"><?php echo $full_name; ?></span><img class="border rounded-circle img-profile" src="assets/img/avatars/avatar5.jpeg"></a>
...
// Get the trainings matching the search query
$trainings = Training::searchTrainings($searchQuery);

// Determine the total number of trainings
$totalTrainings = count($trainings);
// Calculate the total number of pages
$totalPages = ceil($totalTrainings / $itemsPerPage);
// Calculate the offset and limit for the result set
$offset = ($pageNumber - 1) * $itemsPerPage;
$limit = $itemsPerPage;

// Get only the trainings for the current page
$currentTrainings = array_slice($trainings, $offset, $limit);

// Display the trainings for the current page
foreach ($currentTrainings as $training) {
    ?>
...
<?php } ?>
    ...
    <div id="pagination" class="d-flex justify-content-center">
        <!-- <a class="pagination-item disabled" href="#"><img src="assets/img/icon_arrow-left.svg"><span>Previos</span></a><a class="pagination-item active" href="#">1</a><a class="pagination-item" href="#">2</a><a class="pagination-item" href="#">3</a><a class="pagination-item" href="#">...</a><a class="pagination-item" href="#"><span>Next</span><img src="assets/img/icon_arrow-right.svg"></a> -->
        <?php if ($pageNumber > 1) {
    echo '<a class="pagination-item" href="?q=' . $searchQuery . '&page=' . ($pageNumber - 1) . '"><img src="assets/img/icon_arrow-left.svg"><span>Previous</span></a>';
} else {
    echo '<a class="pagination-item disabled" href="#"><img src="assets/img/icon_arrow-left.svg"><span>Previous</span></a>';
}
...
for ($i = 1; $i <= $totalPages; $i++) {
    if ($i == $pageNumber) {
        ...
        // Display ellipsis if there are more than 3 pages and the current page is not near the beginning or end
        if ($totalPages > 3 && $i > 2 && $i < ($totalPages - 1) && abs($i - $pageNumber) > 1) {
            echo '<a class="pagination-item" href="#">...</a>';
            $i = $totalPages - 1;
        }
        echo '<a class="pagination-item" href="?q=' . $searchQuery . '&page=' . $i . '">' . $i . '</a>';
    }
}

// Display next button
if ($pageNumber < $totalPages) {
    echo '<a class="pagination-item" href="?q=' . $searchQuery . '&page=' . ($pageNumber + 1) . '"><span>Next</span><img src="assets/img/icon_arrow-right.svg"></a>';
} else {
    echo '<a class="pagination-item disabled" href="#"><span>Next</span><img src="assets/img/icon_arrow-right.svg"></a>';
}
